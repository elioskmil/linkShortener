...
app.get('/links/:id', async (req,res) => {
    let gotLink = await getFromID(req.params.id);
    res.send(gotLink);
});

app.get('/madr/:short', async (req,res) => {
    let longLink = await getFromShort(req.params.short);
    //res.send(longLink);
    //@TODO add clicks increment here
